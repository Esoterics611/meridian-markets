...
!!! abstract "Where this chapter fits"
    ...
    **Feeds into:** [§7 production](07-production.md) — the runbook in [§8.9](#89-the-desk-runbook-scan-capture-tune-launch-forward-paper) is the operational loop that produces the shadow-mode and min-capital numbers §7's ramp gates on; and **[§9](09-the-fair-value-result.md)–[§11](11-directional-market-making.md)**, where the tapes this stack captures produced the desk's decisive findings (naive MM loses to adverse selection → the fair-value engine → carry as a chosen bet). If [§8.5.1](#851-the-aggressor-feed-real-taker-flow-not-a-candle-estimate)'s "the loss was adverse selection, not phantom fills" caught your eye, **[§9](09-the-fair-value-result.md) is the full story.**
