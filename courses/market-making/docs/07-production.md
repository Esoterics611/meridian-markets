...
!!! abstract "Where this chapter fits"
    ...
    **Feeds into:** the live operation of any market-making book. The on-call posture in [§7.7](#77-the-on-call-posture) and the demotion gates in [§7.10](#710-what-demotes-a-strategy-from-live) are the binding constraints under which every later strategy you bolt on (multi-level, cross-venue, basis, options) inherits its operational envelope.
