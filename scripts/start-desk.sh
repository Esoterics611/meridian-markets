...
MM_FAST_SYMBOLS="${MM_FAST_SYMBOLS:-SOL,ADA,DOGE,SUI,FARTCOIN,kPEPE}" \
...
MM_HEDGE_BETA_MAP="${MM_HEDGE_BETA_MAP:-SOL|ETH|1.02,ADA|ETH|1.04,DOGE|ETH|0.94,SUI|ETH|1.29,FARTCOIN|ETH|1.54,kPEPE|ETH|1.20}" \
